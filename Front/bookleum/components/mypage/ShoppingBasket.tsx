...
export default function ShoppingBasket() {
  return (
    <div className="w-[80%] mx-auto ml-8">
      ...
      <div className="w-full h-[30px] bg-gradient-to-r from-gray-600 to-gray-700 mt-2 flex justify-between items-center pr-4">
        <p className="font-semibold text-white pl-4">주문 번호 : 123456789</p>
        <p className="font-semibold text-white">구매날짜 : 2024년 10월 5일</p>
      </div>
      ...
      <div className="flex py-6  pl-8 justify-between mb-4 border-b border-black shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]">
        <div className="w-[30%] flex justify-center items-center">
          <Image src="/book.png" width={150} height={100} alt="book" />
        </div>
        <div className="flex flex-col justify-between w-[70%] p-4 ">
